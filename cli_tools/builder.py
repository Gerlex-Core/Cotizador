...
def build_tauri():
    console.print("[cyan]Compilando App Nativa (Tauri)...[/cyan]")
    ...
    try:
        subprocess.run(["npm", "run", "tauri", "build"], cwd=cwd, check=True, shell=(os.name=='nt'))
...
def menu():
    while True:
        ...
        console.print("2. Compilar App Movil (Tauri)")
        console.print("3. Compilar Todo")
