...
def list_companies() -> List[str]:
    ...
    # Combine with DB
    db_comps = list_companies_from_db()
    for c in db_comps:
...
@router.get("/details")
def list_companies_details() -> List[Dict[str, Any]]:
...
@router.get("/{name}")
def get_company_detail(name: str) -> Dict[str, Any]:
...
@router.post("")
def save_company(company: CompanyPayload) -> Dict[str, Any]:
...
def download_company_file(name: str):
